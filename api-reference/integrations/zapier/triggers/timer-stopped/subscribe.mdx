---
title: "Subscribe to Timer Stopped Webhooks"
description: "Set up real-time webhook notifications for timer stop events in your Zapier integrations."
---
...
<ParamField body="description" type="string" optional>
  ...
  **Example:** `"Zapier integration for timer stop notifications"`
</ParamField>
